...
function BioSection() {
  const bioData = [
    ...
    { icon: BriefcaseBusiness, title: "Currently Working as a Backend Engineer at Ur Heaven Space Pvt Ltd.", type: "text" },
    { icon: MapPin, title: "Dwarka, Delhi, India", type: "text" },
    { icon: Phone, title: "+91 76329-76843", type: "link" },
    { icon: Mail, title: "iamandaa.dev@gmail.com", type: "link" },
    { icon: Globe, title: "iamandaa.vercel.app", type: "link" },
  ];
  return (
